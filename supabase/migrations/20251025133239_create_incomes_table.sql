...
CREATE INDEX idx_incomes_supplier_id ON public.incomes(supplier_id);
CREATE INDEX idx_incomes_order_id ON public.incomes(order_id);
...
CREATE UNIQUE INDEX idx_incomes_unique_order ON public.incomes(order_id) WHERE order_id IS NOT NULL;
