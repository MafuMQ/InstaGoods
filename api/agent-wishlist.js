// api/agent-wishlist.js
// Vercel API route — proxies to the Supabase agent-wishlist Edge Function
...
export default async function handler(req, res) {
  ...
  const upstreamUrl = `${supabaseUrl}/functions/v1/agent-wishlist?user_jwt=${encodeURIComponent(user_jwt)}`;
